...
return [
     ...
     *
     * Spec 001 FR-02 / FR-11 require 30 minutes. Kept in sync with
     * config/auth-security.php via the same environment variable — a config file
     * cannot read another config file reliably under `config:cache`.
     */
    'default_expires_in_minutes' => (int) env('AUTH_OTP_EXPIRES_IN_MINUTES', 30),
     ...
     */
    'notification' => AuthOneTimePasswordNotification::class,
