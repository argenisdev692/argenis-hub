...
description: Always-on security baseline for this Laravel 13 + Vue 3 + Inertia v3 project. Use when writing, reviewing, or auditing ANY backend or frontend change. Merges OWASP Top 10:2025, API Security Top 10:2023, and LLM Top 10:2025 into a 15+1-point checklist covering auth, access control, injection, supply chain, and exceptional conditions.
---
...
- Concrete implementation rules live in:
  - Backend → `.opencode/skills/BACKEND-PHP/SKILL.md`
  - Frontend → `.opencode/skills/FRONTEND/SKILL.md`
  - Architecture → `.opencode/skills/ARCHITECTURE-PHP/SKILL.md` and `SKILL-SIMPLE-CRUD.md`
  - Vue/Inertia tree → `.opencode/skills/ARCHITECTURE-VUE/SKILL.md`
...
- Backend implementation rules: `.opencode/skills/BACKEND-PHP/SKILL.md` §10 (Security), §11 (Audit/Observability)
- Frontend implementation rules: `.opencode/skills/FRONTEND/SKILL.md` §14 (Frontend Security)
- Architecture (Hexagonal + DDD): `.opencode/skills/ARCHITECTURE-PHP/SKILL.md`
- Simple CRUD baseline: `.opencode/skills/ARCHITECTURE-PHP/SKILL-SIMPLE-CRUD.md`
- Vue/Inertia tree: `.opencode/skills/ARCHITECTURE-VUE/SKILL.md`
- Workflows: `.opencode/commands/ (backend|frontend)-(new|audit).md`
