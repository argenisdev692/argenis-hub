...
1. Read `.opencode/skills/FRONTEND/SKILL.md` and `.opencode/skills/ARCHITECTURE-VUE/SKILL.md`
...
For each item in the checklist: generate the file following the exact rules in `.opencode/skills/FRONTEND/SKILL.md` and the security baseline in `.opencode/skills/OWASP/SKILL.md`.
