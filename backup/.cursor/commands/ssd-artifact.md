...
3. If `.specify/memory/constitution.md` or `CONSTITUTION.md` exists in the project, read it first:
   ...
   not blocking.
4. Copy the templates from `.opencode/skills/SSD/` (`spec_template.md`, `plan_template.md`,
...
1. From the user's description, write `specs/NNN-{slug}/spec.md` using
   `.opencode/skills/SSD/spec_template.md`: summary, motivation, actors, user stories with
...
1. Write `specs/NNN-{slug}/plan.md` using `.opencode/skills/SSD/plan_template.md`: verified stack,
...
1. Write `specs/NNN-{slug}/tasks.md` using `.opencode/skills/SSD/tasks_template.md`, grouping tasks
...
- `.opencode/skills/SSD/spec_template.md` — Phase 1 template.
- `.opencode/skills/SSD/plan_template.md` — Phase 4 template.
- `.opencode/skills/SSD/tasks_template.md` — Phase 5 template.
