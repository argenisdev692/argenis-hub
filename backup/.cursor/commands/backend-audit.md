...
- Simple CRUD → `.opencode/skills/ARCHITECTURE-PHP/SKILL-SIMPLE-CRUD.md`
- Intermediate / complex → `.opencode/skills/ARCHITECTURE-PHP/SKILL.md`
...
1. Read `.opencode/skills/BACKEND-PHP/SKILL.md` — single source of truth for backend rules
2. Read `.opencode/skills/OWASP/SKILL.md` — the always-on security baseline (15+1 items mapped to OWASP Top 10:**2025** + API Top 10:2023 + LLM Top 10:2025 when AI is in scope)
...
For each ❌ FAIL: apply the minimal fix following the exact rules in `.opencode/skills/BACKEND-PHP/SKILL.md` and the security baseline in `.opencode/skills/OWASP/SKILL.md`.
