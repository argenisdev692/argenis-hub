...
1. Read `.opencode/skills/BACKEND-PHP/SKILL.md` and `.opencode/skills/ARCHITECTURE-PHP/SKILL.md` (intermediate baseline)
...
**Architecture (`.opencode/skills/ARCHITECTURE-PHP/SKILL.md`)**
...
For each item in the checklist: generate the file following the exact rules in `.opencode/skills/BACKEND-PHP/SKILL.md` and the security baseline in `.opencode/skills/OWASP/SKILL.md`.
