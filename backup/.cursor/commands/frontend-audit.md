...
1. Read `.opencode/skills/FRONTEND/SKILL.md` — single source of truth for frontend rules
...
Then apply the minimal fix following the exact rules in `.opencode/skills/FRONTEND/SKILL.md` and the security baseline in `.opencode/skills/OWASP/SKILL.md`.
