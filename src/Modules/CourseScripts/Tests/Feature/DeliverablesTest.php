...
it('renders the script in the reference layout', function (): void {
    ...
    expect($markdown)->toContain('# GUIÓN – VÍDEO 1 — Vídeo 1')
        ...
        ->and($markdown)->toContain('## EJERCICIO PRÁCTICO — Tu primera comparativa real')
        ->and($markdown)->toContain('**Tu reto:** Conecta tu Drive')
        ->and($markdown)->toContain('- Las cifras coinciden con los originales')
