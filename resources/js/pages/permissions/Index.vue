...
import { buildPermissionQueryParams } from '@/modules/authorization/helpers/buildPermissionQueryParams';
import type {
...
const exportParams = computed(() => buildPermissionQueryParams(filters.value));
