...
**Cloud & DevOps:** **AWS** (S3 · EC2 · Route 53 · RDS) · Docker Compose / Laravel Sail · GitHub Actions · Cloudflare Workers / R2 · Railway · VPS · Laravel Pint · **PHPUnit** · OWASP

**Integrations & AI:** Google Calendar / OAuth · Google Meet · Resend · SumUp · DocuSign · Google Maps · Supabase · laravel/ai · Claude AI · Firecrawl · Tavily · GitHub Copilot · Cursor · Tabnine
...
- **Recorded** "**Cursor AI** for Web Development": **6 hours / 12 videos** on AI-assisted coding workflows in the Cursor editor.
...
**Imagina Web & Mobile Technologies** _|   Online - Remote   |   2025_
...
- **Taught** a live course to **25 students** over **5 sessions / 25 hours**, covering **Tabnine** for web development with **.NET** and **React**.
...
- "**Microsoft 365 Copilot** for Users" - Imagina Formacion, Spain (2026) - recorded course, 7h / 32 videos (short-form / video-pill format)
