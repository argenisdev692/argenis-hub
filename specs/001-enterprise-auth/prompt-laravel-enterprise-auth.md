...
- Activación / verificación de email con **código de 6 dígitos** (OTP, expira 30 min) — no enlaces firmados 
...
- Reset por email con **código de 6 dígitos** (OTP, expira 30 min, uso único) — no enlaces/tokens 
...
- I Reset de password con código de 6 dígitos de uso único (OTP, expira 30 min) 
